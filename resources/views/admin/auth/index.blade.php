        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div style="margin-bottom:10px;text-align:right;">
                    <button class="btn btn-danger" onclick="window.location.href='{{URL::route('webmanagent.auth.create')}}'">+ 增加权限信息</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                            ...
                                            <td class="center" style="width:70px;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ URL::route('webmanagent.auth.edit',$item->auth_label)}}">编辑</a></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="deleteContent('{{ URL::route('webmanagent.auth.destroy',$item->auth_label)}}','{{$item->auth_name}}')">删除</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>

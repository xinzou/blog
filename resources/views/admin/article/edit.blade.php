                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="{{URL::route('webmanagent.article.update',$articleInfo->id)}}" method="post" enctype="multipart/form-data">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <input class="form-control" id="title" name="title" type="text" value="@if (!empty(Session::get('title'))){{Session::get('title')}}@elseif($articleInfo->title){{$articleInfo->title}}@endif">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <select id="cate_id" name="cate_id" class="form-control" style="width: 150px">
                                                    @foreach($categoryTreeList as $key => $val)
                                                        <option value="{{$key}}"@if (Session::get('cate_id') == $key) selected="true"@elseif($articleInfo->cate_id == $key) selected="true"@endif>{{$val}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" id="tags" name="tags" type="text" value="@if (!empty(Session::get('tags'))){{Session::get('tags')}}@elseif($articleInfo->tags){{$articleInfo->tags}}@endif">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                {{--<input class="form-control" id="pic" name="pic" type="text" value="@if (!empty(Session::get('pic'))){{Session::get('pic')}}@elseif($articleInfo->pic){{$articleInfo->pic}}@endif">--}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label" for="content">内容</label>
                                            <div class="col-lg-10">
                                                <textarea id="content" name="content" >@if (!empty(Session::get('content'))){{Session::get('content')}}@elseif($articleInfo->content){{$articleInfo->content}}@endif</textarea>
                                            </div>
                                        </div>
...
{{--    <script type="text/javascript" language="javascript" src="{{ asset('plugins/tinymce/plugins/google-code-prettify/prettify.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('plugins/tinymce/plugins/google-code-prettify/prettify.css') }}" type="text/css" />--}}
    <script>
        tinymce.init({
            selector: 'textarea',
            language: 'zh_CN',

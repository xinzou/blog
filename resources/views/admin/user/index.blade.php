        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div style="margin-bottom:10px;text-align:right;">
                    <button class="btn btn-danger" onclick="window.location.href='{{URL::route('webmanagent.user.create')}}'">+ 增加用户</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                            ...
                                            <td class="center" style="width:70px;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ URL::route('webmanagent.user.show',$item->user_id)}}">用户详情</a></li>
                                                        <li><a href="{{ URL::route('webmanagent.user.edit',$item->user_id)}}">编辑</a></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="deleteContent('{{ URL::route('webmanagent.user.destroy',$item->user_id)}}','{{$item->username}}')">删除</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>

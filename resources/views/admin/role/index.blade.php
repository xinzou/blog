        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div style="margin-bottom:10px;text-align:right;">
                    <button class="btn btn-danger" onclick="window.location.href='{{URL::route('webmanagent.role.create')}}'">+ 增加角色</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                            ...
                                            <td class="center" style="width:70px;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ URL::route('webmanagent.role.show',$item->role_id)}}">角色详情</a></li>
                                                        <li><a href="{{ URL::route('webmanagent.role.edit',$item->role_id)}}">编辑</a></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="deleteContent('{{ URL::route('webmanagent.role.destroy',$item->role_id)}}','{{$item->role_name}}')">删除</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>

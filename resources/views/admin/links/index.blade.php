...
@section('content')
    ...
    <script type="text/javascript">
        @if (Session::has('dialog'))
            ...
            content:"&nbsp;&nbsp;&nbsp;友情链接名称:{{Session::get('dialog')['message']['name']}}<br/>&nbsp;&nbsp;&nbsp;地址:{{Session::get('dialog')['message']['url']}}<br/>"
        });
        @endif
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div style="margin-bottom:10px;text-align:right;">
                    <button class="btn btn-danger" onclick="window.location.href='{{URL::route('webmanagent.links.create')}}'">+ 增加友情链接</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if (Session::has('operationstatus') && Session::get('operationstatus') == 'sucess')
                            <div class="alert alert-success">
                                <a class="close" data-dismiss="alert" href="#">&times;</a>
                                <strong>Success!</strong> 删除友情链接成功.
                            </div>
                        @endif
                                            ...
                                            <td class="center" style="width:70px;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ URL::route('webmanagent.links.edit',$item->id)}}">编辑</a></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="deleteContent('{{ URL::route('webmanagent.links.destroy',$item->id)}}','{{$item->name}}')">删除</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>

...
@section('content')
    ...
    <script type="text/javascript">
        @if (Session::has('dialog'))
            ...
            content:"&nbsp;&nbsp;&nbsp;分类名称:{{Session::get('dialog')['message']['cate_name']}}<br/>&nbsp;&nbsp;&nbsp;别名:{{Session::get('dialog')['message']['as_name']}}<br/>&nbsp;&nbsp;&nbsp;seo标题:{{Session::get('dialog')['message']['seo_title']}}<br/>&nbsp;&nbsp;&nbsp;seo 关键字:{{Session::get('dialog')['message']['seo_key']}}<br/>"
        });
        @endif
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div style="margin-bottom:10px;text-align:right;">
                    <button class="btn btn-danger" onclick="window.location.href='{{URL::route('webmanagent.category.create')}}'">+ 增加文章分类</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if (Session::has('operationstatus') && Session::get('operationstatus') == 'sucess')
                            <div class="alert alert-success">
                                <a class="close" data-dismiss="alert" href="#">&times;</a>
                                <strong>Success!</strong> 删除文章分类成功.
                            </div>
                        @endif
                            ...
                            <div class="bootstrap-admin-panel-content">
                                <table class="table table-striped table-bordered" id="example">
                                    ...
                                    @foreach ($categoryList as $item)
                                        <tr>
                                            <td>{{ $item->html}} {{$item->cate_name}}</td>
                                            ...
                                            <td class="center" style="width:70px;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ URL::route('webmanagent.category.edit',$item->id)}}">编辑</a></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="deleteContent('{{ URL::route('webmanagent.category.destroy',$item->id)}}','{{$item->cate_name}}')">删除</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>

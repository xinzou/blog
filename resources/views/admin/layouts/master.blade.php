                    ...
                    <ul class="nav navbar-nav">
                        @if(check_auth('QXZX'))
                            <li @if(Session::get('nav')->Top === 'QXZX')class="active"@endif><a
                                        href="{{ URL::route('webmanagent.user.index')}}">权限中心</a></li>
                        @endif
                        @if(check_auth('NRGL'))
                            <li @if(Session::get('nav')->Top === 'NRGL')class="active"@endif><a
                                        href="{{ URL::route('webmanagent.category.index')}}">内容管理</a></li>
                        @endif
                        @if(check_auth('XTSZ'))
                            <li @if(Session::get('nav')->Top === 'XTSZ')class="active"@endif><a
                                        href="{{ URL::route('webmanagent.systems.index')}}">系统设置</a></li>
                        @endif
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div>

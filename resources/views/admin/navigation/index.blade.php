...
@section('content')
    ...
    <script type="text/javascript">
        @if (Session::has('dialog'))
            ...
            content:"&nbsp;&nbsp;&nbsp;导航名称:{{Session::get('dialog')['message']['name']}}<br/>&nbsp;&nbsp;&nbsp;地址:{{Session::get('dialog')['message']['url']}}<br/>"
        });
        @endif
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div style="margin-bottom:10px;text-align:right;">
                    <button class="btn btn-danger" onclick="window.location.href='{{URL::route('webmanagent.navigation.create')}}'">+ 增加导航</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                            ...
                                            <td class="center" style="width:70px;">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ URL::route('webmanagent.navigation.edit',$item->id)}}">编辑</a></li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="deleteContent('{{ URL::route('webmanagent.navigation.destroy',$item->id)}}','{{$item->name}}')">删除</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </td>
